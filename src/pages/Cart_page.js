      ...
      <div className="box-content h-full w-3/4 mx-auto border-2 p-4 my-10">
        ...
        <div className="flex justify-between">
          <div>
            ...
            <h1 className="font-semibold text-lg">{ post.product_name }</h1>
            ...
            <h1 className="font-semibold text-lg"> Harga : Rp { post.product_price }</h1>
            <button
            ...
            <button
              className="w-full button h-8 bg-gray-400 text-white hover:bg-gray-800 mt-3"
              onClick={(e) => Decrement(post.cart_id, post.product_price, post.cart_amount, post.cart_total)}
            >
              {" "}
              Kurang
            </button>
            <button
              className="w-full button h-8 bg-gray-400 text-white hover:bg-gray-800 mt-3"
              onClick={(e) => Increment(post.cart_id, post.product_price, post.cart_amount, post.cart_total)}
            >
              {" "}
              Tambah
            </button>
            <h1 className="font-semibold text-lg"> Jumlah : { post.cart_amount }</h1>
            <h1 className="font-semibold text-lg"> Total : Rp { post.cart_total }</h1>
